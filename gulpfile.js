...
elixir(function(mix) {
    ...
    mix.copy('bower_components/semantic/dist/themes/default/**', 'public/build/css/themes/default');
...
function s3() {
    ...
    _.mapValues(json, function(file) {
        ...
        var params = {Bucket: 'cdn.snugfeed.com', Key: 'build/'+file, Body: fs.readFileSync('public/build/'+file), ACL: 'public-read', ContentType: contentType};
