        ...
        <>
            ...
            <div className="min-h-screen bg-slate-100">
                ...
                <div className="max-w-lg m-auto text-sm mt-10">
                    <p className="mb-4">
                        SnugFeed let's you stay up to date will all your
                        favorite news sources in one place updated in real-time!
                    </p>
                    <p className="mb-4">
                        Select from some of our pre-existing feeds below to try
                        it out.
                    </p>
                    <p className="mb-4">
                        Register and get access to add as many feeds and you
                        want as well as your own custom feeds!
                    </p>
